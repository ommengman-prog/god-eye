...
3. Once the interface opens, you will see options to enter the main domain you want to scan.

4. Input the domain and click on the "Start Scan" button.

5. Wait for the tool to analyze the domain. The results will appear in the interface.
